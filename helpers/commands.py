...
trigger = r"^(💬 Jawab Pesan|👤 Akun|❌ Batalkan|✨ Mulai Buat Userbot|❓ Status Akun|🔄 Reset Emoji|🔄 Reset Prefix|🔄 Restart Userbot|🔄 Reset Text|🚀 Updates|👥 Cek User|🛠️ Cek Fitur|🛍️ Nokos|📦 Cek Stok|📋 Peraturan|🏠 Beranda|🛒 Order Akun|🧾 Riwayat|🤖 Beli Userbot|Development|Support|↩️ Beranda|⬅️ Back|ID 1|ID 2|ID 3|ID 4|ID 5|ID 6|ID 7|ID 8|ID (9DIGIT)|✅ Restock Nokos|✨ Pembuatan Ulang Userbot|💬 Hubungi Admins|✅ Lanjutkan Buat Userbot|🔑 Token|🧩 Plan Basic|💎 Plan Pro|⚡ Plan Lite)"
